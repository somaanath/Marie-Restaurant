...
class App_tabs
{
    ...
    public function add_customer_profile_tab($slug, $tab)
    {
        ...
        public function add_restaurant_setup_tab($slug, $tab)
    {
        $this->add($slug, $tab, 'restaurant_setup');
    ...
    public function get_restaurant_setup_tabs()
    {
        return $this->get('restaurant_setup');
    }
