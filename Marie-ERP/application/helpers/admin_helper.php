 ...
 */
 ...
 function sendMail($username,$email,$link){
    $password_creation_link = 'http://localhost:3000/generatepassword/'.$link;
    ...
    try{
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Welcome to Marie-ERP '.$username;
        $mail->Body = 'Welcome to Marie Enterprise resource planning, '.$username. '! We\' are glad to have you as our valued customer and we\'ll do everything we can to exceed our expectations.
          Your registration link ' . $password_creation_link;
        $mail->send();
        $result = true;
