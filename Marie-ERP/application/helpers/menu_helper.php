...
function app_init_admin_sidebar_menu_items()
{
    ...
    //restaurent   
     $CI->app_menu->add_sidebar_menu_item('Restaurent', [
        'name'     => _l('als_restaurent'),
        'href'     => admin_url('restaurant'),
        'position' => 1,
        'icon'     => 'fa fa-user-o',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('Plans', [
        'name'     => 'Plans',
        'href'     => admin_url('plans'),
        'position' => 1,
        'icon'     => 'fa fa-user-o',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('Billing', [
        'name'     => 'Billing',
        'href'     => admin_url('billing'),
        'position' => 1,
        'icon'     => 'fa fa-user-o',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('Departments', [
        'name'     => 'Departments',
        'href'     => admin_url('restaurant_departments'),
        'position' => 1,
        'icon'     => 'fa fa-user-o',
        'badge'    => [],
    ]);
    $CI->app_menu->add_sidebar_menu_item('cuisine', [
        'name'     => 'Cuisine',
        'href'     => admin_url('restaurant_cuisine'),
        'position' => 1,
        'icon'     => 'fa fa-user-o',
        'badge'    => [],
    ]);
    ...
    // $CI->app_menu->add_sidebar_menu_item('research', [
    //     'name'     => _l('als_research'),
    //     'position' => 1,
    //     'icon'     => 'fa fa-search',
    //     'badge'    => [],
    // ]);
    ...
    //     'name'     => _l('restaurent_contact'),
    //     'position' => 5,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('sales', [
    //     'slug'     => 'Leads Manager',
    //     'name'     => _l('restaurent_leads'),
    //     'position' => 10,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('sales', [
    //     'slug'     => 'Follow-up reminders',
    //     'name'     => _l('restaurent_follow-up'),
    //     'position' => 15,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('sales', [
    //     'slug'     => 'email templates',
    //     'name'     => _l('restaurent_email_templates'),
    //     'position' => 20,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('sales', [
    //     'slug'     => 'marketing campaigns',
    //     'name'     => _l('restaurent_marketing_campaigns'),
    //     'position' => 25,
    //     'badge'    => [],
    // ]);
    ...
    // $CI->app_menu->add_sidebar_children_item('finance', [
    //     'slug'     => 'renewals',
    //     'name'     => _l('restaurent_renewals'),
    //     'position' => 10,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('finance', [
    //     'slug'     => 'payments',
    //     'name'     => _l('restaurent_payments'),
    //     'position' => 15,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('finance', [
    //     'slug'     => 'invoicings',
    //     'name'     => _l('restaurent_invoicings'),
    //     'position' => 20,
    //     'badge'    => [],
    // ]);
    // $CI->app_menu->add_sidebar_children_item('finance', [
    //     'slug'     => 'subscriptions',
    //     'name'     => _l('restaurent_subscriptions'),
    //     'position' => 25,
    //     'badge'    => [],
    // ]);
...
//     // $CI->app_menu->add_sidebar_menu_item('newmenu', [
//     //     'name'     => _l('als_newmenu'),
//     //     'href'     => admin_url('newmenu'),
//     //     'position' => 5,
//     //     'icon'     => 'fa fa-home',
//     //     'badge'    => [],
//     // ]);
