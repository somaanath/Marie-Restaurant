...
function get_cuisine_types()
{
    $CI = & get_instance();

    return $CI->db->get(db_prefix() . 'cuisine_type')->result_array();
}
...
function get_restaurant_types()
{
    ...
    return $CI->db->get(db_prefix() . 'restaurant_business_types')->result_array();
}

function get_reach_types()
{
    $CI = & get_instance();

    return $CI->db->get(db_prefix() . 'restaurant_reach')->result_array();
}
...
function get_countries()
{
    ...
    return $CI->db->get(db_prefix() . 'countries')->result_array();
}


function get_departments_types()
{
    $CI = & get_instance();

    return $CI->db->get(db_prefix() . 'restaurant_departments')->result_array();
}
...
function get_plans()
{
    ...
    return $CI->db->get(db_prefix() . 'restaurant_plans')->result_array();
}
...
function get_payment_status()
{
    ...
    return $CI->db->get(db_prefix() . 'payment')->result_array();
}
...
function get_time()
{
    ...
    return $CI->db->get(db_prefix() . 'restaurant_time_stamp')->result_array();
}
...
function get_cuisine_data()
{
    $CI = & get_instance();

    return $CI->db->get(db_prefix(). 'restaurant_cuisine')->result_array();
}
