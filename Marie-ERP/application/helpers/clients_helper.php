...
function get_restaurant_setup_tabs()//restaurant controller la call pananum
{
    return get_instance()->app_tabs->get_restaurant_setup_tabs();
}
 ...
 */
 ...
 function restaurant_setup_tabs()
{
    $client_id = null;
    ...
    $CI->app_tabs->add_restaurant_setup_tab('basic_information', [
        'name'     => _l('basic_info'),
        'icon'     => 'fa fa-user-circle',
        'view'     => 'admin/restaurant/setup_module/basic_info',
        'position' => 10,
    ]);

    $CI->app_tabs->add_restaurant_setup_tab('cuisine_types', [
        'name'     => _l('cuisine_type'),
        'icon'     => 'fa fa-user-circle',
        'view'     => 'admin/restaurant/setup_module/cuisine_types',
        'position' => 10,
    ]);
    $CI->app_tabs->add_restaurant_setup_tab('sales_channel', [
        'name'     => 'Sales Channel',
        'icon'     => 'fa fa-sticky-note-o',
        'view'     => 'admin/restaurant/setup_module/sales_channel',
        'position' => 15,
    ]);
    $CI->app_tabs->add_restaurant_setup_tab('departments', [
        'name'     => _l('departments'),
        'icon'     => 'fa fa-sticky-note-o',
        'view'     => 'admin/restaurant/setup_module/departments',
        'position' => 20,
    ]);
