...
class Knowledge_base_model extends App_Model
{
    ...
    {
        $this->db->select('slug,articleid, articlegroup, subject, articleNumber, ' . db_prefix() . 'knowledge_base.description,' . db_prefix() . 'knowledge_base.active as active_article,' . db_prefix() . 'knowledge_base_groups.active as active_group,name as group_name,staff_article');
